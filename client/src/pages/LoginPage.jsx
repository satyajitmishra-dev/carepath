...
export default function LoginPage({ onNavigate }) {
  ...
  const handleEmailLogin = (e) => {
    e.preventDefault();
    // For hackathon, push users purely to Google Auth for perfectly synced profiles
    toast('Email login coming soon! Please use Google to continue.', {
      icon: '🔐',
      ...
      >
        <div className="glass-dark p-8 sm:p-10 !rounded-3xl shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-emerald-100/50 text-sm text-center mb-8">
            ...
            <p className="text-center text-emerald-100/50 text-xs mt-8">
              ...
              <button onClick={() => onNavigate('signup')} className="text-emerald-400 font-bold hover:underline bg-transparent border-none cursor-pointer">
                Sign up
              </button>
            </p>
          </div>
